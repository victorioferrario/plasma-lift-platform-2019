...
function cors()
{
    ...
    header('Access-Control-Allow-Origin: '."http:///www.plasma-lift.net");
    header('Access-Control-Allow-Credentials: true');   
}

function get_email_headers($to_email, $form_email, $cc_email) {
...
function get_email_body($subject, $from_name, $from_email, $user_message) {
    ...
    $message .= "<fieldset><legend>Message</legend>$user_message</fieldset>";
    $message .= '</body></html>';
...
if(empty($errors))
{
    ...
    $email_subject = "Contact Web Submission";

	$email_body = get_email_body($email_subject, $from_name, $from_email, $message);	    
